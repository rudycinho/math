...
De aqui se obtiene que $x^2 = z^2$, i.e. , $x \sim z$.
Por tanto, $\sim$ es una relacion de equivalencia. $\blacksquare$


**Ejemplo:** En $\mathbb{R}$ se definie la relacion
$$x \triangle y \Longleftrightarrow $$
